...
class BiDirectionalInterpreter:
              ...
              with sr.Microphone(**mic_kwargs) as source:
                            ...
                            while self.running:
                                              try:
                                                                    ...
                                                                    threading.Thread(target=self._outbound_process, args=(audio,), daemon=True).start()
    ...
    def start(self):
        ...
        self._loopback = LoopbackCapture(device_index=self.cable_b_idx, on_audio_ready=self._inbound_process)
